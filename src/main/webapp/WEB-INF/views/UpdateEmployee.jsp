...
<input type="hidden" name="empId" value="${viewemployee.empId}">
<input type="hidden" name="userId" value="${viewemployee.userId}">
												...
												<fieldset>
													...
													<div class="field">
														<label for="userName">UserName:</label> <input
															type="text" id="user_Name" name="userName" value="${viewemployee.userName}"
													...
													<div class="field">
														<label for="password">Password:</label> <input
															type="password" id="pass_word" name="password" value="${viewemployee.password}"
