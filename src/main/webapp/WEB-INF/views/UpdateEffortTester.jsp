	...
	<div class="navbar navbar-fixed-top">
		...
		<div class="navbar-inner">
			...
			<div class="container">
				...
				</a> <a class="brand" href="index.html"> Actual Test Effort by ${userInfo.userName } </a>
					...
					<div class="span12">
						...
						<div class="widget ">
							...
							<div class="widget-header">
								<i class="icon-user"></i>
								<h3>Actual Test Effort by ${userInfo.userName } </h3>
							</div>
							<!-- /widget-header -->
							...
							<div class="widget-content">
								...
								<div class="tabbable">
									...
									<form action="${pageContext.request.contextPath}/updateTestEffort" method="get"
										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="#userStoryDetails">
												...
												<fieldset>
													...
													<div class="field">
														<label for="actualEffort_Test">Actual Effort:</label> <input
															type="text" id="actualEffort_Test" name="actualEffort_Test"
															value="" placeholder="ActualEffort Test" class="login" />
													</div>
													<!-- /field -->
													...
													<div class="field">
														<label for="employeeID">EmployeeId:</label> <input
															...
															value="${productBackLogUserStory.testerID}"
													...
													<div class="field">
														<label for="Day">Day:</label> <input type="text" id="day"
															name="day" value="" placeholder="Day" class="login" />
													</div>
