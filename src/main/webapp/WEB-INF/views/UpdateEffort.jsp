...
<head>
<meta charset="utf-8">
<title>Update Developer Effort</title>
	...
	<div class="navbar navbar-fixed-top">
		...
		<div class="navbar-inner">
			...
			<div class="container">
				...
				</a> <a class="brand" href="index.html"> Actual Effort By Developer - ${userInfo.userName } </a>
					...
					<div class="span12">
						...
						<div class="widget ">
							...
							<div class="widget-header">
								<i class="icon-user"></i>
								<h3>Update Effort by ${userInfo.userName}</h3>
							</div>
							<!-- /widget-header -->
							...
							<div class="widget-content">
								...
								<div class="tabbable">
									...
									<form action="${pageContext.request.contextPath}/updateEffort" method="get"
										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="#userStoryDetails">
												...
												<fieldset>
													...
													<div class="field">
														<label for="actualEffort_Dev">Actual Effort:</label> <input
															type="text" id="actualEffort_Dev" name="actualEffort_Dev"
															value="" placeholder="ActualEffort Dev" class="login" />
													</div>
													<!-- /field -->
