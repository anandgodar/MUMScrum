...
<head>
<meta charset="utf-8">
<title>Estimate Test Effort</title>
	...
	<div class="navbar navbar-fixed-top">
		...
		<div class="navbar-inner">
			...
			<div class="container">
				...
				</a> <a class="brand" href="index.html"> Update Estimate Effort By Tester - ${userInfo.userName } </a>
							...
							<tbody>
								...
								<c:forEach items="${listOfUserStories}" var="userStory">
									...
									<tr>
										...
										<td class="td-actions"><a href="<c:url value="/estimateTestEffortUserStory/${userStory.getId()}" />"
								...
								<tr>
									<td colspan="4" align="center"><c:forEach var="i" begin="0" end="${totalNumberOfRecord}">
   										<a href="<c:url value="/updateEstimateEffortTester/${i}" />"><c:out value="${i}" /></a>
										</c:forEach></td>
								</tr>
