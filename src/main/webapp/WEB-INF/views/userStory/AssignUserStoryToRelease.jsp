					...
					<c:forEach items="${unAssignedUserStories}" var="UnAssigneduserStory">
						<li>
							...
							<div class="news-item-detail">
								...
								</p><a href="<c:url value="/userstory/updatereleaseid/${UnAssigneduserStory.getProductid()}/${rid}/${UnAssigneduserStory.getId()}"/>"  class="news-item-title" >
								Add to Current Release</a>
							</div>
