		...
		<div class="container">
			...
			<div class="nav-collapse">
				<ul class="nav pull-right">
					...
					<li class="">						
						<a href='<c:url value="/"></c:url>' class=""> <!-- all values in session so just / -->
		...
		<form action="viewEmployeeDetails" method="post">
			...
			<h1>Employee Details</h1>			
				...
				<div class="field">
					...
					<input type="text" id="user_Name" name="userName" value="${viewemployee.getUser().getUserName()}" placeholder="user Name" class="login"/>
				</div> <!-- /field -->
				
				<div class="field">
					<label for="password">Password:</label>
					<input type="text" id="pass_word" name="password" value="${viewemployee.getUser().getPassword()}" placeholder="Password" class="login"/>
				</div> <!-- /field -->
...
<div class="login-extra">
	Back? <a href="<c:url value="/"></c:url>">click here</a>
</div> <!-- /login-extra -->
