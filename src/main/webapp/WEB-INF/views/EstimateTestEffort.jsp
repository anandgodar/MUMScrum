						...
						<div class="widget ">
							...
							<div class="widget-content">
								...
								<div class="tabbable">
									...
									<form action="${pageContext.request.contextPath}/updateTestEstimateEffort" method="get"
										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="#userStoryDetails">
												...
												<fieldset>
													...
													<div class="field">
														<label for="estimateEffort_Test">Test Estimate Effort:</label> <input
															type="text" id="estimateEffort_Test" name="estimateEffort_Test"
															value="${productBackLogUserStory.estimateEffort_Test}" placeholder="EstimateEffort Test" class="login" />
													</div>
													<!-- /field -->
