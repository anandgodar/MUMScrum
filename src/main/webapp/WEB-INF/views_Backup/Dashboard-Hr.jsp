          ...
          <div class="widget">
            ...
            <div class="widget-content">
              <ul class="messages_layout">
                <li class="from_user left"> <a href="#" class="avatar"><img src="<spring:url value="/resources/img/message_avatar1.png"/>"/></a>
                ...
                <li class="by_myself right"> <a href="#" class="avatar"><img src="<spring:url value="/resources/img/message_avatar2.png"/>"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
